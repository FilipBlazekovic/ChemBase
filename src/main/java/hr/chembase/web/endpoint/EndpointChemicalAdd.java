...
@Path("/chemicals/add")
public class EndpointChemicalAdd extends ResourceConfig {
    ...
    public Response addChemical(@CookieParam("sessionID") Cookie sessionCookie, JSONChemicalManagementRequest request)
    {
        long startTime               = System.nanoTime();
        ObjectChemical addedChemical = null;
        ...
        if (request != null)
        {
            ...
            if (molarMass != null)      molarMass = molarMass.trim().replaceAll(",", ".");
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        int i = 1;
                        statement = connection.prepareStatement(SQLStatements.ADD_CHEMICAL_SQL);
                        ...
                        i = 1;
                        statement = connection.prepareStatement(SQLStatements.GET_LAST_ADDED_CHEMICAL);
                        statement.setString(i++, chemicalName);
                        statement.setString(i++, bruttoFormula);
                        statement.setString(i++, molarMass);
                        statement.setBigDecimal(i++, amount);
                        ...
                        {
                            addedChemical = new ObjectChemical();
                            addedChemical.setId(resultSet.getInt(1));
                            addedChemical.setChemicalName(resultSet.getString(2));
                            addedChemical.setBruttoFormula(resultSet.getString(3));
                            addedChemical.setMoralMass(resultSet.getString(4));
                            addedChemical.setQuantity(resultSet.getBigDecimal(5));
                            addedChemical.setUnit(resultSet.getString(6));
                            addedChemical.setStorageLocation(resultSet.getString(7));
                            addedChemical.setManufacturer(resultSet.getString(8));
                            addedChemical.setSupplier(resultSet.getString(9));
                            addedChemical.setDateOfEntry(resultSet.getString(10));
                            addedChemical.setAdditionalInfo(resultSet.getString(11));
                        }
        ...
        if (RETURN_STATUS)
        {
            ...
            response.setChemicals(addedChemical);
