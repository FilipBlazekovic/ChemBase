...
@Path("/locations/edit")
public class EndpointLocationEdit extends ResourceConfig {
    ...
    public Response editLocation(@CookieParam("sessionID") Cookie sessionCookie, JSONLocationManagementRequest request)
    {
        ...
        logger.info("ENDPOINT: /locations/edit");
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        statement = connection.prepareStatement(SQLStatements.EDIT_LOCATION_SQL);
